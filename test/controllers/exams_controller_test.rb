...
class ExamsControllerTest < ActionController::TestCase
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post :create, exam: { date: @exam.date, description: @exam.description, group: @exam.group, subject: @exam.subject, title: @exam.title }
    end
  ...
  test "should update exam" do
    patch :update, id: @exam, exam: { date: @exam.date, description: @exam.description, group: @exam.group, subject: @exam.subject, title: @exam.title }
    assert_redirected_to exam_path(assigns(:exam))
  end
