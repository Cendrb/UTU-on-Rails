...
class HolidaysControllerTest < ActionController::TestCase
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post :create, holiday: { holiday_beginning: @holiday.holiday_beginning, holiday_end: @holiday.holiday_end, school_year_id: @holiday.school_year_id }
    end
  ...
  test "should update holiday" do
    patch :update, id: @holiday, holiday: { holiday_beginning: @holiday.holiday_beginning, holiday_end: @holiday.holiday_end, school_year_id: @holiday.school_year_id }
    assert_redirected_to holiday_path(assigns(:holiday))
  end
